...
@section('konten')
    <div class="row mb-4">
        <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-light btn-sm mt-1 mb-2 tambah-pengguna"><i class="bi bi-plus"></i>
                        Tambah Pengguna
                    </button>
                    <div class="modal fade text-left" id="modal-form" data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        <div class="modal-dialog modal-md modal-dialog-centered">
                            <div class="modal-content">
                                <form id="form-pengguna" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel33">Tambah pengguna</h5>
                    ...
                    <div class="modal fade text-left" id="modal-form-edit" data-bs-backdrop="static"
                        ...
                        <div class="modal-dialog modal-md modal-dialog-centered">
                            <div class="modal-content">
                                <form id="form-edit-pengguna" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="input-group input-group-outline my-2">
                                                    <label class="form-label">Email</label>
                                                    <input name="email_edit" id="email_edit" class="form-control"
                                                        type="text">
                                                    <div class="input-group has-validation">
                                                        <label
                                                            style="margin-top: 0.1rem; font-size: 0.8rem; font-weight: 600;"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="input-group input-group-outline my-2">
                                                    <label class="form-label">Password</label>
                                                    <input name="password_edit" id="password_edit" class="form-control">
                                                    <div class="input-group has-validation">
                                                        <label
                                                            style="margin-top: 0.1rem; font-size: 0.8rem; font-weight: 600;"
                                                            class="text-danger error-text password_edit_error">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-footer"
                                        ...
                                        <button type="submit" class="btn btn-sm btn-info btn-sm"
                                            name="action-button-edit" id="action-button-edit" value="Tambah">
...
@push('script')
    <script>
        var table = $('.user_datatable').DataTable({
            ...
            ajax: "{{ route('ManajemenPengguna.HalamanUser.User') }}",
            columns: [{
                    data: 'name',
                    name: 'name'
                }, {
        ...
        $('.tambah-pengguna').on('click', function() {
        ...
        $(document).on('click', '.edit-pengguna', function(event) {
        ...
        $('#form-pengguna').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('ProsesTambahPengguna') }}",
                method: "POST",
